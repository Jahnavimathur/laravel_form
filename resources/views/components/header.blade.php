            ...
            <div class="header-controls">
                ...
                <div class="cart-wrapper header-links">
                    ...
                    <div class="of-notification-comment">
                        ...
                        <div class="of-nt-flex">
                            <div class="of-nt-img">
                                <img src="{{url('assets/images/product2.png')}}" alt=""/>
                            </div>
                        ...
                        <div class="of-nt-flex">
                            <div class="of-nt-img">
                                <img src="{{url('assets/images/product3.png')}}" alt=""/>
                            </div>
                            <div class="of-nt-cmnt">
                                <p>Wooden Sofa<span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="9px" height="8px">
                        ...
                        <div class="of-nt-flex">
                            <div class="of-nt-img">
                                <img src="{{url('assets/images/product.png')}}" alt=""/>
                            </div>
                            <div class="of-nt-cmnt">
                                <p>Dining Chair<span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="9px" height="8px">
                ...
                <div class="user-info-wrapper header-links">
                    <a href="javascript:void(0);" class="user-info">
                        <img src="{{url('assets/images/user.jpg')}}" alt="" class="user-img">
