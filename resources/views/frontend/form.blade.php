                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="sku" placeholder="Enter SKU" id="sku">
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="capacity" placeholder="Enter Capacity" id="capacity">
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            <label for="" class="col-form-label">Opening Stock</label>
                                            <input class="form-control" type="text" name="openingstock" placeholder="Enter Opening Stock" id="openingstock">
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            <label for="" class="col-form-label">Buffer Stock</label>
                                            <input class="form-control" type="text" name="bufferstock" placeholder="Enter Buffer Stock" id="bufferstock">
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <table class="table table-bordered" id="dynamic_field">
                                                ...
                                                <tbody id="tbody">
                                                        <tr class="defaultTr">
                                                            <td>
                                                                <input type="text" name="item[]" class="form-control" placeholder="Raw Material Name here..">
                                                            </td>
                                                            <td>
